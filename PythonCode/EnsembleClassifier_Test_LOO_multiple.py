...
for datanum in np.arange(num_data):
    ...
    mat_confusion[:,0:3,datanum] = confusion_matrix(Y, Y_pred)
    mat_confusion[:,3:,datanum] = confusion_matrix(Y_shuffled, Y_shuffled_pred)
    print('{:d} finished'.format(datanum))
...
savemat('20JUN1.mat',{'mat_accuracy' : mat_accuracy, 'mat_confusion' : mat_confusion})
