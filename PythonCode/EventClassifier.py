...
# Constants
BASE_PATH = Path('D:\Data\Lobster\Lobster_Recording-200319-161008\EventClassifierDataset')
REGEXP_CONDITION = '*_PL*.mat'
...
for datanum, data_path in enumerate(datalist):
    ...
    score_shuffled_f1 = f1_score(Y_shuffled, Y_pred_shuffled)
    score_real_f1 = f1_score(Y_real, Y_pred_real)
    ...
    mat_f1[datanum,0] = score_shuffled_f1
    mat_f1[datanum,1] = score_real_f1
...
savemat(OUTPUT_FILE_PATH/'output.mat',{'dataname' : data_name, 'mat_accuracy' : mat_accuracy, 'mat_balanced_accuracy' : mat_balanced_accuracy,
                                       'mat_f1' : mat_f1, 'mat_confusion' : mat_confusion})
