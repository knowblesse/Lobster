...
numTank = 24;
output_table = table(strings(numTank, 1), zeros(numTank, 1), zeros(numTank, 1), zeros(numTank, 2),...
    'VariableNames', {'Tank', 'Error_Distracted', 'Error_Engaged', 'NumData'});
...
for i = 1 : numTank
    ...
    distracted = readmatrix("D:\Data\Lobster\Lobster_Recording-200319-161008\Data\" + tank_name + "\bool_distracted.csv");
