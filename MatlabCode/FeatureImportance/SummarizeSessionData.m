...
BNBResult_Predictive = load('D:\Data\Lobster\BNB_Result_fullshuffle.mat');
...
for i_session = 1 : 40
    ...
    Sessions.BNB_HW_Accuracy_Predictive(i_session) = BNBResult_Predictive.result{i_session}.balanced_accuracy_HWAE(2);
    ...
    Sessions.N_Pred(i_session) = sum(...
        Unit.Session == session & ...
        Unit.Group_HW_A == 2 & ... %Predictive one
        Unit.Group_HW_E ~= 1); 
